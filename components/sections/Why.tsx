        ...
        >
          ...
          <div className="relative -mx-5 -mt-10 overflow-hidden rounded-t-[1.6rem] bg-[#040604] md:-mx-10 md:-mt-14 md:rounded-t-[1.6rem] lg:mx-0 lg:mt-0 lg:rounded-none">
            ...
            <div className="md:hidden">
              ...
              {/* foto */}
<div className="absolute bottom-[-40px] right-[-48px] z-[3] h-[365px] w-[285px] min-[390px]:bottom-[-30px] min-[390px]:right-[-38px] min-[390px]:h-[395px] min-[390px]:w-[310px]">
                <Image
...
<p className="font-[family-name:var(--font-bodoni)] text-[1.08rem] font-medium leading-[1.3] text-[#F4EBDD] min-[390px]:text-[1.15rem] md:text-[1.1rem] md:leading-8">    <span className="block">
