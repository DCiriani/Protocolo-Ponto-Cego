    ...
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute right-[-70px] top-[120px] z-10 h-[430px] w-[280px] opacity-75 md:right-[-30px] md:top-[120px] md:h-[620px] md:w-[420px] lg:right-[20px] lg:h-[700px] lg:w-[460px]">
            <Image
