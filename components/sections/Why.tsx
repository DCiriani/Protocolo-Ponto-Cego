  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        >
          {/* ============ TOPO ============ */}
          <div className="relative -mx-5 -mt-10 overflow-hidden rounded-t-[1.6rem] bg-[#040604] md:-mx-10 md:-mt-14 lg:-mx-14 lg:-mt-14">
...
<div className="absolute bottom-[-15px] right-[-80px] z-[3] h-[365px] w-[285px] min-[390px]:bottom-[-5px] min-[390px]:right-[-70px] min-[390px]:h-[395px] min-[390px]:w-[310px]">
            ...
            <div className="relative md:flex md:items-stretch">
              {/* coluna de texto */}
<div className="relative z-10 min-h-[425px] px-5 pt-1 min-[390px]:min-h-[445px] md:min-h-0 md:flex-1 md:pl-10 md:pr-8 md:pt-8 lg:pl-14 lg:pt-2">
...
<span className="hidden lg:inline">
  A situação mudava. A forma de interpretar, se proteger e reagir permanecia.
              ...
              <div className="relative hidden shrink-0 md:block md:h-[500px] md:w-[320px] lg:h-[560px] lg:w-[450px]">
                ...
                {/* círculos decorativos */}
                <div className="pointer-events-none absolute right-[-130px] top-6 z-[2] h-[440px] w-[440px] rounded-full border border-[#6F8F5E]/10 lg:right-[-90px] lg:h-[520px] lg:w-[520px] lg:border-[#6F8F5E]/[0.06] lg:blur-[2px]" />
                <div className="pointer-events-none absolute right-[-70px] top-20 z-[2] h-[340px] w-[340px] rounded-full border border-[#6F8F5E]/10 lg:right-[-30px] lg:h-[420px] lg:w-[420px] lg:border-[#6F8F5E]/[0.06] lg:blur-[2px]" />
