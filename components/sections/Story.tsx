...
>
  ...
  className="relative mx-auto mt-8 max-w-[380px] px-4 text-center font-satoshi text-[0.98rem] italic leading-[1.5] text-[#B8AE96] md:mt-10 md:max-w-[720px] md:text-[1.45rem] md:leading-[1.6]"
>
