...
function Commitment() {
  ...
  Compromisso
              ...
              {/* título */}
              <h2 className="mx-auto mt-8 max-w-[760px] text-center font-[family-name:var(--font-bodoni)] text-[1.95rem] font-medium uppercase leading-[1.08] tracking-[0.015em] text-[#F4EBDD] min-[390px]:text-[2.15rem] md:text-[3.7rem] lg:text-[5rem]">
  Se algo não fizer
  <br />
  sentido, eu reviso
  <br />
