    ...
    >
      <div className="absolute inset-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[90%_top] opacity-95 -translate-y-22 scale-[4.12] origin-top-right md:object-[78%_top] md:-translate-y-12 md:scale-[1.1] lg:object-[82%_top] lg:-translate-y-10 lg:scale-[1.08] xl:translate-y-0 xl:scale-100"
        />
