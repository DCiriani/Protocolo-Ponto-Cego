...
export default function Hero() {
  ...
  <span className="block whitespace-nowrap text-[#88B39A]">
    um Ponto cego
            ...
            <p className="mt-7 w-fit max-w-[21rem] whitespace-nowrap font-serif text-[0.92rem] leading-tight tracking-[-0.01em] text-[#F5F5F3] min-[390px]:text-[0.98rem] sm:max-w-none sm:text-[1.35rem] md:mt-10 md:text-[2rem]">
